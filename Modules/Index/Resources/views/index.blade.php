...
@section('content')
                                ...
                                <div class="main-search-box">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="select-input">
                                                <select name="neighborhoods[]" id="neighborhoods_form"
                                                    data-placeholder="محله را انتخاب کنید" class="chosen-select-no-single"
                                                    multiple>
                                                    @foreach ($neighborhoods as $neighborhood)
                                                        <option value="{{ $neighborhood->id }}"
                                                            data-provine="{{ $neighborhood->province->id }}"
                                                            {{ $neighborhood->is_disabled(1) }}>{{ $neighborhood->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="range-slider">
                                                ...
                                                <div class="findeo-range" data-name="area"
                                                    ...
                                                    data-max="{{ $extremum['max_area'] }}" data-unit="مترمربع"
                                                    data-step="10"></div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="range-slider">
                                                ...
                                                <div class="findeo-range" data-name="year_of_construction"
                                                    ...
                                                    data-max="{{ $extremum['max_year_of_construction'] }}" data-unit=""
                                                    data-step="1"></div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="total_price" style="width: 100%">
                                            ...
                                            <div class="range-slider">
                                                ...
                                                <div class="findeo-range" data-name="total_price"
                                                    ...
                                                    data-max="{{ $extremum['max_total_price'] }}" data-unit="میلیون تومان"
                                                    data-step="10"></div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="more-search-options d-none" style="position: inherit">
                                        <div class="more-search-options-container"
                                            style="padding: inherit;box-shadow: none">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="select-input">
                                                    ...
                                                    <select name="usetypeproperties[]"
                                                        ...
                                                        placeholder="نوع را انتخاب کنید" class="chosen-select-no-single"
                                                        multiple>
                                            ...
                                            <div class="checkboxes in-row">
                                                ...
                                                @foreach ($terms as $term)
                                                    <input name="terms[{{ $term->id }}]"
                                                        id="termcheckbox{{ $term->id }}" type="checkbox">
                                                    <label
                                                        for="termcheckbox{{ $term->id }}">{{ $term->title }}</label>
                                                @endforeach
                                            </div>
                                            <!-- Checkboxes / End -->
                                    ...
                                    <div class="row with-forms">
                                        ...
                                        <div style="display: flex;justify-content: space-between;width: 100%;">
                                            ...
                                            <div>
                                                <!-- More Search Options -->
                                                <a class="more-search-options-trigger" data-open-title="گزینه های بیشتر"
            ...
            <div class="my-listings-container grid-layout-three" style="padding-right: 1rem; padding-left:1rem;">
                ...
                @foreach ($estates as $estate)
                    ...
                    <div class="listing-item estate-item" data-estateid="{{ $estate->id }}">
                        ...
                        <div href="{{ route('show', $estate->slug) }}" class="listing-img-container"
                            style="height: auto;">
                            ...
                            <div class="listing-img-content d-flex align-items-center"
                                style="background-color: rgba(74,74,76,0.7);">
                                ...
                                @else
                                    <span class="listing-price">{{ number_format($estate->total_price) }}
                                        تومان </span>
                                @endif
                                <i class="fa-solid fa-code-compare text-white estate-icon"
                                    onclick="return add_to_compare('{{ $estate->id }}')"></i>
                                <i class="fa fa-heart text-white estate-icon {{ in_array($estate->id, $liked_estates_id_array) ? 'active' : null }}"
                                    onclick="return add_to_favorite('{{ $estate->id }}')"></i>
                            </div>

                            <img src={{ $estate->thumbnail_picture() }} alt="" style="height: 260px;">
                        ...
                        <div class="listing-content">
                            ...
                            <div class="listing-footer">
                                ...
                                <span><i
                                        class="fa fa-calendar-o"></i>{{ verta($estate->updated_at)->formatDifference() }}</span>
                            </div>
    ...
    <!-- Flip banner -->
    <a href="/" class="flip-banner parallax" data-background="/findeo/images/flip-banner-bg.jpg"
        data-color="var(--maincolor)" data-color-opacity="0.9" data-img-width="2500" data-img-height="1600">
