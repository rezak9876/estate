        ...
        <div class="row margin-bottom-50">
            <div class="col-md-12">
                ...
                <div class="property-slider-nav">
                    @if ($estate->main_picture)
                        <div class="item"><img
                                src="{{ \Modules\Estate\Entities\Gallery::$prefix_images . $estate->main_picture }}"
                                alt="" height="80px" style="margin: auto">
                        </div>
                    @endif
                    @foreach ($estate->galleries as $gallery)
                        <div class="item"><img
                                src="{{ \Modules\Estate\Entities\Gallery::$prefix_images . $gallery->path }}" alt=""
                    ...
                    <div class="widget">
                        <form action="{{ route('search') }}" id="filter_form" method="post">
                            ...
                            <div class="row with-forms">
                                ...
                                <div class="col-md-12">
                                    <select name="type" data-placeholder="نوع" class="chosen-select-no-single">
                                        <option value="{{ \Modules\Estate\Entities\Estate::Buy_Sell }}">
                                            {{ \Modules\Estate\Entities\Estate::text(\Modules\Estate\Entities\Estate::Buy_Sell) }}
                                        </option>
                                        <option value="{{ \Modules\Estate\Entities\Estate::Mortgage_Rent }}">
                                            {{ \Modules\Estate\Entities\Estate::text(\Modules\Estate\Entities\Estate::Mortgage_Rent) }}
                                        </option>
                                        <option value="{{ \Modules\Estate\Entities\Estate::Presell }}">
                                            {{ \Modules\Estate\Entities\Estate::text(\Modules\Estate\Entities\Estate::Presell) }}
                                        </option>
                                        <option value="{{ \Modules\Estate\Entities\Estate::Exchange }}">
                                            {{ \Modules\Estate\Entities\Estate::text(\Modules\Estate\Entities\Estate::Exchange) }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row with-forms">
                                <!-- Status -->
                                <div class="col-md-12">
                                    <select name="usetypeproperties[]" data-placeholder="وضعیت"
                                        ...
                                        @foreach ($usetypes as $usetype)
                                            <optgroup label="{{ $usetype->title }}">
                                                @foreach ($usetype->usetypeproperties as $usetypeproperty)
                                                    <option value="{{ $usetypeproperty->id }}">
                                                        {{ $usetypeproperty->title }}</option>
                                                @endforeach
                                            </optgroup>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row with-forms">
                                ...
                                <div class="col-md-12">
                                    <select name="neighborhoods[]" id="neighborhoods_form"
                                        data-placeholder="محله را انتخاب کنید" class="chosen-select-no-single" multiple>
                                        @foreach ($neighborhoods as $neighborhood)
                                            <option value="{{ $neighborhood->id }}"
                                                data-provine="{{ $neighborhood->province->id }}"
                                                {{ $neighborhood->is_disabled(1) }}>{{ $neighborhood->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="range-slider">
                                ...
                                <div class="findeo-range" data-name="area" data-min="{{ $extremum['min_area'] }}"
                                    data-max="{{ $extremum['max_area'] }}" data-unit="مترمربع" data-step="10"></div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="range-slider">
                                <div class="range-slider">
                                    ...
                                    <div class="findeo-range" data-name="year_of_construction" data-min="0"
                                        data-max="1500" data-unit="سال" data-step="1"></div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div id="total_price">
                                ...
                                <div class="range-slider">
                                    ...
                                    <div class="findeo-range" data-name="total_price"
                                        ...
                                        data-max="{{ $extremum['max_total_price'] }}" data-unit="تومان" data-step="10">
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="range-slider">
                                        ...
                                        <div class="findeo-range" data-name="mortgage_price"
                                            ...
                                            data-max="{{ $extremum['max_mortgage_price'] }}" data-unit="تومان"
                                            data-step="10"></div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="range-slider">
                                        ...
                                        <div class="findeo-range" data-name="rent_price"
                                            ...
                                            data-max="{{ $extremum['max_rent_price'] }}" data-unit="تومان"
                                            data-step="10"></div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                        ...
                                        @if ($facility->type == \Modules\Facility\Entities\Facility::Integer)
                                            <div class="col-md-12">
                                                <div class="range-slider">
                                                    ...
                                                    <div class="findeo-range" data-name="facility[{{ $facility->id }}]"
                                    ...
                                    @foreach ($facilities as $facility)
                                        @if ($facility->type == \Modules\Facility\Entities\Facility::Check_box)
                                            <input name="check_box_facility[{{ $facility->id }}]"
                                                id="facilitycheckbox{{ $facility->id }}" type="checkbox">
                                            <label
                                                for="facilitycheckbox{{ $facility->id }}">{{ $facility->title }}</label>
                                        @endif
                                    @endforeach
                ...
                <div class="col-md-4">
                    <div class="listing-item compact">
                        ...
                        <a href="{{ route('show', $like_estate->slug) }}" class="listing-img-container"
                            ...
                            <img src={{ $like_estate->thumbnail_picture() }} alt="">
                        </a>
